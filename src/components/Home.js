...
const EcoVestHomepage = ({ onNavigate }) => {
  ...
  return (
    <div className="homepage">
      ...
      <section className="tech-preview-section" style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', padding: '80px 0', color: 'white' }}>
        <div className="section-container">
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(255,255,255,0.1)', padding: '12px 24px', borderRadius: '50px', marginBottom: '24px' }}>
              <Cpu style={{ width: '20px', height: '20px', marginRight: '8px' }} />
              <span>Technical Deep Dive Available</span>
            </div>
            
            <h2 style={{ fontSize: '48px', fontWeight: 'bold', marginBottom: '24px' }}>
              Explore the <span style={{ background: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Technology</span> Behind ESG Tokenization
            </h2>
            
            <p style={{ fontSize: '20px', opacity: '0.9', marginBottom: '40px' }}>
              Dive deep into the blockchain infrastructure, smart contracts, and AI-powered 
              systems that could power the future of transparent ESG investing.
            </p>
